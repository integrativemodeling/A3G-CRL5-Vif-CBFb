...
# Read files
###########################
modeling_script = '../scripts/mod_A3G_Vif_CRL5_flexible.py'
mmcif_file = '../scripts/A3G-CRL5-Vif_complex_flexible.cif'

analysis_dir = '../results/model_flexible/'
clustering_dir = os.path.join(analysis_dir,'clustering_flexible')
rmf3 = os.path.join(clustering_dir,'cluster.0','cluster_center_model.rmf')
...
################################################
input_information['Experimental data'] = ['131 DSSO chemical cross-links']
...
representation['Spatial restraints encoded into scoring function'].append('Structural equivalence distance restraints; applied to the R1 representation')
...
validation['Percent of excluded volume restraints satisfied per structure'] = ['97 \%']
...
# 
################################################
variable_dict = {'complex': 'A3G\_Vif\_CRL5 with flexible representation',
                 'number':1,
...
utils.compile_pdf_from_template(template, variable_dict, './table_SI_A3G_Vif_CRL5_flexible.pdf')
