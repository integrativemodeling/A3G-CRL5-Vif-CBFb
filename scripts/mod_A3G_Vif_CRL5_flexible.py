...
include_amg_distance_restraint = False
include_Occams = True
top_dir = '../'
...
if '--mmcif' in sys.argv:
    ...
    title = """Characterization of a A3G-VifHIV-1-CRL5-CBFb structure using a 
...
if '--mmcif' in sys.argv:
    ...
    for asym in po.asym_units:
        name = asym.split('.')[0]
        fname = f'../results/model_flexible/clustering_flexible/cluster.0/LPD_{name}_orie.mrc'
        print('fname', fname)
